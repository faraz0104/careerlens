...
const appJsonLd = {
  ...
  name: "CareerLens Software Engineer Resume Checker",
  url: "https://www.carrerlens.com/software-engineer-resume-checker",
  description: "Free ATS resume checker for software engineers — ATS score and tech keyword gaps for Google, Amazon, Flipkart and Indian startups",
...
const relatedTools = [
  ...
  { href: "/interview/google", label: "Google Interview" },
