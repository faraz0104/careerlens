...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!post) return {};
  return {
    title: `${post.metaTitle} | CareerLens Blog`,
...
export default async function BlogPostPage({ params }: Props) {
  ...
  const articleJsonLd = {
    ...
    publisher: { "@type": "Organization", name: "CareerLens", url: "https://www.carrerlens.com" },
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: post.title, item: `https://www.carrerlens.com/blog/${post.slug}` },
    ],
  };
      ...
      <div style={{ minHeight: "100vh", background: "#f7f6f2", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <nav style={{ background: "#1a1916", padding: "0 2rem", position: "sticky", top: 0, zIndex: 100 }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", height: 52, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
              <Link href="/blog" style={{ color: "rgba(247,246,242,.7)", fontSize: ".82rem", textDecoration: "none" }}>← Blog</Link>
        ...
        <div style={{ background: "#fff", borderBottom: "1px solid #e5e2de", padding: "10px 2rem" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", fontSize: ".75rem", color: "#9a958f" }}>
            ...
            <span style={{ margin: "0 6px" }}>›</span>
            <span style={{ color: "#5a5650" }}>{post.category}</span>
          </div>
        </div>
        ...
        <div style={{ background: post.coverColor, padding: "40px 2rem 36px" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
              <span style={{ background: "#e85a2a", color: "#fff", fontSize: ".68rem", fontWeight: 700, padding: "3px 10px", borderRadius: 20, letterSpacing: ".05em", textTransform: "uppercase" }}>{post.category}</span>
            ...
            <div style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <span style={{ color: "rgba(247,246,242,.6)", fontSize: ".78rem" }}>{formatDate(post.publishedAt)}</span>
              <span style={{ color: "rgba(247,246,242,.3)" }}>·</span>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 2rem", display: "grid", gridTemplateColumns: "1fr 300px", gap: 40, alignItems: "start" }}>
          ...
          <article>
            ...
            <div style={{ marginTop: 36, background: "linear-gradient(135deg, #1a1916, #2d2c28)", borderRadius: 14, padding: "24px 28px" }}>
              <div style={{ fontSize: ".72rem", fontWeight: 700, letterSpacing: ".07em", textTransform: "uppercase", color: "#e8a020", marginBottom: 8 }}>Put this into action</div>
              <div style={{ color: "#f7f6f2", fontWeight: 700, fontSize: "1rem", marginBottom: 6 }}>Get your ATS score and skill gap analysis — free</div>
              <div style={{ color: "rgba(247,246,242,.65)", fontSize: ".82rem", marginBottom: 18 }}>Upload your resume and see exactly which skills you're missing for your target roles.</div>
          ...
          <aside style={{ position: "sticky", top: 68 }}>
            ...
            <div style={{ background: "#fff", border: "1px solid #e5e2de", borderRadius: 12, padding: "18px 20px" }}>
              ...
              {[
                ["📄 Resume Analyzer", "/", "Get your ATS score free"],
                ["📚 Interview Q&A", "/interview-questions", "500+ questions with answers"],
                ["🏢 AI Interview Prep", "/interview", "Company-specific questions"],
                ["💰 Salary Intelligence", "/salary", "Know what you're worth"],
              ].map(([label, href, desc]) => (
        ...
        {related.length > 0 && (
          <div style={{ background: "#fff", borderTop: "1px solid #e5e2de", padding: "40px 2rem" }}>
            <div style={{ maxWidth: 1100, margin: "0 auto" }}>
              <div style={{ fontWeight: 800, fontSize: "1.1rem", color: "#1a1916", marginBottom: 24 }}>More from the blog</div>
        ...
        {/* FOOTER */}
        <div style={{ borderTop: "1px solid #e5e2de", padding: "24px 2rem", textAlign: "center", fontSize: ".75rem", color: "#9a958f", marginTop: 0 }}>
          © 2026 CareerLens ·{" "}
